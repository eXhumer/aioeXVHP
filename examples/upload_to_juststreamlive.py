...
from aioexvhp.model import JustStreamLiveUploadData


async def upload_to_juststreamlive(video_path: Path):
    async with Client() as aioexvhp:
        video = await aioexvhp.upload_to_juststreamlive(
...
async def main():
    ...
    await upload_to_juststreamlive(video_path)
